...
public abstract class Enemy extends Character {
	...
	public void calculateMove() {
		...
		//  nhớ cập nhật lại giá trị cho _moving khi thay đổi trạng thái di chuyển
		...
		if(_steps <= 0) {
            ...
            /*
                giống như bomber  nhận cái directon từ ai sẽ đi theo chiều
            0 lên trên
            2 xuống dưới 
            1 sang phải
            3 sang trái
	...
	public void kill() {
		if(!_alive) return;
		_alive = false;
		Message msg = new Message("Die", getXMessage(), getYMessage(), 2, Color.white, 14);
