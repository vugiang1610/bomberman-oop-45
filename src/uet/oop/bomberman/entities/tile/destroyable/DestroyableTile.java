...
public class DestroyableTile extends Tile {
	...
	protected boolean _destroyed = false; // kiểm tra đã bị phá hủy hay chưa
	protected int _timeToDisapear = 20; // thời gian để biến mất của 1 bức tường gạch
	protected Sprite _belowSprite = Sprite.grass; // hình ảnh bên dưới gạch
	...
	public void update() {
		...
		if(_destroyed) {
			if(_animate < MAX_ANIMATE) {
				_animate++; // thay đổi ảnh khi mà bom nổ
			} else {
				_animate = 0;
			}
