...
public class Bomb extends AnimatedEntitiy {
	...
	protected double _timeToExplode = 120; //thời gian bom chờ nổ:2s
	public int _timeAfter = 20; // thời gian cho vụ nổ kết thúc
	
	protected Board _board;
	protected Flame[] _flames; // tầm ảnh hưởng của bom 
	protected boolean _exploded = false; // kiểm tra xem bom đã nổ chưa
	protected boolean _allowedToPassThroght = true; // có thể đi qua lúc bomber đặt bom
	...
	public FlameSegment flameAt(int x, int y) {
        ...
        /**
         * 
         * @param e thực thể  có thể là bomber hoặc flame của quả bom mới nỏ
	...
	public boolean collide(Entity e) {
        // xử lý khi Bomber đi ra sau khi vừa đặt bom (_allowedToPassThroght)
            ...
            if(e instanceof Bomber) { // thực thể có phải là bomberman
                ...
                // kiểm tra xem bomber đã rời vị chí quả bom vừa đặt lúc nãy chưa
                if(!( diffY >= 1 && diffY <= 30 && diffX >= -10 && diffX < 16 )) { 
                            // trả về và ko thể qua vị chí đó đc nữa
